...
// declared as `const`
const name = 'Joseph';
const email = 'josephkfuentes@gmail.com';
...
// TODO: rewrite the following using arrow functions // (Parenthesis ),  => arrow , {}bracket
users.forEach((user) => {
...
// });
    developers.push(`${name} email is ${email} and ${name}  knows ${languages.join(', ')}`)
